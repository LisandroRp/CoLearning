...
export default class MapaVarios extends Component {
  state = {
    markers: [
      {
        coordinate: {
      ...
      <View style={styles.container}>
        ...
        >
          {this.state.markers.map((marker, index) => {
            ...
            return (
              <MapView.Marker key={index} coordinate={marker.coordinate} onPress={() => this.onMarkerPressed(marker, index)}>
